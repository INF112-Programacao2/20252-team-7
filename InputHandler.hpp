...
public:
    ...
    // Se o usuario digitar o caractere 'exitSymbol' (padrão '#'), o método retorna
    // string vazia para indicar cancelamento/saida da sessao.
    static std::string getCPF(const std::string& prompt, char exitSymbol = '#');
